...
def face_detect(img_path):
    ...
    # face_cascade = cv2.CascadeClassifier(r'D:\Python_workspace\face_express\faceexp_Recognition-release\haarcascade\haarcascade_frontalface_alt.xml')
...
def predict_expression():
    ...
    while (True):
        ...
        #img_path = input(r'D:\大学\计设\emo\2.JPG')
        img, img_gray, faces = face_detect(r"./1.PNG")
